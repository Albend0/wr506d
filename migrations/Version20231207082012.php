...
final class Version20231207082012 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie ADD release_date DATETIME DEFAULT NULL, ADD description LONGTEXT DEFAULT NULL, ADD duration INT DEFAULT NULL, ADD note DOUBLE PRECISION DEFAULT NULL, ADD entries INT DEFAULT NULL, ADD budget INT DEFAULT NULL, ADD director VARCHAR(255) NOT NULL, ADD website VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD usernaame VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` DROP usernaame');
    }
}
